...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo site_url( 'assets/bootstrap-datepicker-1.6.4-dist/css/bootstrap-datepicker.css' ); ?>">
    ...
    <!--  jQuery is high dependency package, needs to be loaded earlier -->
